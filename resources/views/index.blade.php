            ...
            <div class="col-sm-4">
                <div class="menu">
                    <div class="inner_content">
                        <span class="flaticon flaticon-burger"></span>
                        <a style="color: #fff" href="{{ route('products') }}"><h2>menu</h2></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="drinks">
                    <div class="inner_content">
                        ...
                        <a style="color: #fff" href="{{ route('category' , ['category' => 'beverages']) }}"><h2>drinks</h2></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="sides">
                    <div class="inner_content">
                        ...
                        <a style="color: #fff;" href="{{ route('category' , ['category' => 'breakfast']) }}"><p style="font-size: 35px;padding-left: 100px;padding-top: 17px;">breakfast</p></a>
                    </div>
                </div>
            </div>
